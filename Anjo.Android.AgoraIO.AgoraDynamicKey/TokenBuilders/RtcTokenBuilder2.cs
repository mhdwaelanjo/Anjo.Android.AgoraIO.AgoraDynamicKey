...
namespace Anjo.Android.AgoraIO.AgoraDynamicKey.TokenBuilders
{
    public class RtcTokenBuilder2
    {
        ...
        public static string BuildTokenWithUserAccount(string appId, string appCertificate, string channelName, string account, Role role, uint tokenExpire, uint privilegeExpire)
        {
            ...
            serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegeJoinChannel, privilegeExpire);
            if (Role.RolePublisher == role)
            {
                serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishAudioStream, privilegeExpire);
                serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishVideoStream, privilegeExpire);
                serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishDataStream, privilegeExpire);
            }
                                                ...
                                                uint pubVideoPrivilegeExpire, uint pubDataStreamPrivilegeExpire)
        {
            ...
            serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegeJoinChannel, joinChannelPrivilegeExpire);
            serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishAudioStream, pubAudioPrivilegeExpire);
            serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishVideoStream, pubVideoPrivilegeExpire);
            serviceRtc.AddPrivilegeRtc(AccessToken2.PrivilegeRtcEnum.PrivilegePublishDataStream, pubDataStreamPrivilegeExpire);
            accessToken.AddService(serviceRtc);
        ...
        public static string BuildTokenWithRtm(string appId, string appCertificate, string channelName, string account, Role role, uint tokenExpire, uint privilegeExpire)
        {
            ...
            serviceRtm.AddPrivilegeRtm(AccessToken2.PrivilegeRtmEnum.PrivilegeLogin, tokenExpire);
